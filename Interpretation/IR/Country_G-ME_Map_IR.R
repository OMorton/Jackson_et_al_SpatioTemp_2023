...
#### Read in ####
G_ME_Sum_Aves_EXP <- data.table::fread("Outputs/G-ME/IR/G_ME_Sum_Aves_EXP.csv", na.strings = "") %>%
  rename("iso" = "Exporter")
G_ME_Sum_Amph_EXP <- data.table::fread("Outputs/G-ME/IR/G_ME_Sum_Amph_EXP.csv", na.strings = "") %>%
  rename("iso" = "Exporter") 
G_ME_Sum_Mam_EXP <- data.table::fread("Outputs/G-ME/IR/G_ME_Sum_Mam_EXP.csv", na.strings = "") %>%
  rename("iso" = "Exporter") 
G_ME_Sum_Rept_EXP <- data.table::fread("Outputs/G-ME/IR/G_ME_Sum_Rept_EXP.csv", na.strings = "") %>%
  rename("iso" = "Exporter") 

G_ME_Sum_Aves_IMP <- data.table::fread("Outputs/G-ME/IR/G_ME_Sum_Aves_IMP.csv", na.strings = "") %>%
  rename("iso" = "Importer") 
G_ME_Sum_Amph_IMP <- data.table::fread("Outputs/G-ME/IR/G_ME_Sum_Amph_IMP.csv", na.strings = "") %>%
  rename("iso" = "Importer")
G_ME_Sum_Mam_IMP <- data.table::fread("Outputs/G-ME/IR/G_ME_Sum_Mam_IMP.csv", na.strings = "") %>%
  rename("iso" = "Importer") 
G_ME_Sum_Rept_IMP <- data.table::fread("Outputs/G-ME/IR/G_ME_Sum_Rept_IMP.csv", na.strings = "") %>%
  rename("iso" = "Importer") 
